...
[TODO: 2-3 sentences — working area dimensions, intended use (wood/PCB/foam?), what sets this build apart from off-the-shelf kits]
...
- **Buck converter** for logic power supply
- Firmware: **FluidNC**
...
| Component | Model | Qty |
|---|---|---|
| Microcontroller | [TODO] | 1 |
| Stepper driver | TMC2209 | 4 |
| Buck converter | [TODO] | 1 |
| Stepper motors | [TODO] | [TODO] |
...
[TODO: e.g. MIT for code/firmware, CERN-OHL for the electronics/mechanical design]
